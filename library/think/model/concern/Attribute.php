...
trait Attribute
{
    ...
    protected function isPk($key)
    {
        ...
        else if (is_array($pk) && in_array($key, $pk)) {
            return true;
        }
    ...
    protected function autoWriteTimestamp($name)
    {
        ...
        else if (is_string($this->autoWriteTimestamp) && in_array(strtolower($this->autoWriteTimestamp), [
                'datetime',
                'date',
                'timestamp',
            ])) {
    ...
    public function getAttr($name, &$item = null)
    {
        ...
        else if ($this->autoWriteTimestamp && in_array($name, [$this->createTime, $this->updateTime])) {
