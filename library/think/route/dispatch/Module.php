...
class Module extends Dispatch
{
    ...
    public function init()
    {
        ...
        if ($this->rule->getConfig('app_multi_module')) {
            ...
            else if (!in_array($module, $this->rule->getConfig('deny_module_list')) && is_dir($this->app->getAppPath() . $module)) {
                $available = true;
            }
            else if ($this->rule->getConfig('empty_module')) {
